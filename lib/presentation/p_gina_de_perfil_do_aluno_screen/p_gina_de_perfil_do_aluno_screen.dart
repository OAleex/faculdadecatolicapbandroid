...
class PGinaDePerfilDoAlunoScreen extends StatelessWidget {
  PGinaDePerfilDoAlunoScreen({Key? key}) : super(key: key);
        ...
        child: Scaffold(
            ...
            body: Container(
                ...
                child: Column(children: [
                  CustomImageView(
                      imagePath: ImageConstant.img42380783629905100x100,
  ...
  PreferredSizeWidget _buildAppBar(BuildContext context) {
    return CustomAppBar(
        ...
        centerTitle: true,
        title: AppbarTitle(text: "Perfil do Aluno"),
